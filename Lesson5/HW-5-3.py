...
most_occurred_word = Counter(words_list)
print(f'The most occurred word and occurrence is {most_occurred_word.most_common(1)}')
# print(f'The most occurred word and occurrence is {type(most_occurred_word.most_common(1))}')
